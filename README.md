...
* The "THREADS" variable specifies the number of computational threads used by MaxQuant. Currently, it's set to the max # of CPUs. When changing this variable, ensure your number is enclosed by "str()".
