...
The "MaxQuant" section should NOT be changed. It contains inputs to the MaxQuant pipeline. MaxQuant requires a parameter file (generated by ProteomeGenerator or user-provided), FASTA file (generated by ProteomeGenerator), and Raw files (user-provided, same directory as WD).
...
Furthermore, it will generate all tables outputted from MaxQuant in the user-specified working directory, under "/combined/txt/".
