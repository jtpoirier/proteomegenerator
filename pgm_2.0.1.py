...
rule filter:
    input: bam="out/{run}.Aligned.sortedByCoord.out.bam"
    output: "out/{run}.Aligned.trimmed.out.bam"
...
rule merge:
    input: expand("out/rnaseq_runs/run{run}.stringtie.gtf",run=RNASAMPLE_RUNS)
